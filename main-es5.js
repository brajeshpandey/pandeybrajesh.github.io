...
var BlogEditComponent = /** @class */ (function () {
    ...
    BlogEditComponent.prototype.ngOnInit = function () {
        ...
        this.blogHttpService.getSingleBlog(myBlogId).subscribe(function (data) {
            console.log(data);
...
var BlogHttpService = /** @class */ (function () {
    ...
    BlogHttpService.prototype.getSingleBlog = function (blogId) {
        var myResponse = this._http.get(this.baseUrl + '/view' + '/' + blogId + '?authToken=' + this.authToken);
        return myResponse;
    }; // end get single blog 
...
var BlogService = /** @class */ (function () {
    ...
    BlogService.prototype.getSingleBlog = function (id) {
        ...
        console.log(blogId);
        var foundBlog;
        for (var _i = 0, _a = this.blogArray; _i < _a.length; _i++) {
            var item = _a[_i];
...
var PostBlogComponent = /** @class */ (function () {
    function PostBlogComponent(_route, router, blogService, blogHttpService, toastr, vcr) {
        // this.toastr.setRootViewContainerRef(vcr);
        this._route = _route;
        this.router = router;
        this.blogService = blogService;
